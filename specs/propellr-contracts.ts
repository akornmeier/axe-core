// Proposed, types-only public contract. No runtime or transport implementation.
...
export type VersionRef = { readonly id: string; readonly version: string };
...
export interface Target {
  ...
  readonly path: readonly {
    readonly kind: "frame" | "shadow" | "element";
...
export interface Scope {
  readonly include: NonEmpty<Target>;
  readonly exclude: readonly Target[];
}
...
export interface ScanRequest {
  ...
  readonly rules:
    ...
    | { readonly kind: "explicit"; readonly rules: NonEmpty<RuleSelection> };
}
...
interface SessionRequest extends RequestMeta {
  readonly sessionId: SessionId;
}

export interface Commands {
  readonly open: {
    readonly input: RequestMeta & {
      readonly policy: VersionRef;
      readonly target:
        | {
  ...
  readonly inspect: {
    readonly input: SessionRequest & { readonly operationId?: OperationId };
    readonly output: {
  ...
  readonly scan: {
    readonly input: SessionRequest & { readonly scan: ScanRequest };
    readonly output: Operation<"scan">;
  };
  readonly runPlaybook: {
    readonly input: SessionRequest & {
      readonly playbook: VersionRef;
      readonly inputs: JsonObject;
      readonly bindings: Readonly<Record<string, Target>>;
      readonly secretRefs: Readonly<Record<string, string>>;
    };
    readonly output: Operation<"playbook">;
  };
  readonly subscribe: {
    readonly input: SessionRequest & { readonly after?: string };
