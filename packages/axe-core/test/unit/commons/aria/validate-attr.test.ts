// FIXME(phase-01-followup): blocked by axe-global transitive deps in lib/commons/aria/validate-attr.ts.
...
describe.todo('aria.validateAttr', () => {
  it.todo(
    'migrated from test/commons/aria/validate-attr.js — restore body once Phase 1 gap closed'
  );
});
