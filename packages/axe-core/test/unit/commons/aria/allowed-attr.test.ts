// FIXME(phase-01-followup): blocked by axe-global transitive deps in lib/commons/aria/allowed-attr.ts.
...
describe.todo('aria.allowedAttr', () => {
  it.todo(
    'migrated from test/commons/aria/allowed-attr.js — restore body once Phase 1 gap closed'
  );
});
