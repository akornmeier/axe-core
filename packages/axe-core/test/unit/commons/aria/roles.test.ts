// FIXME(phase-01-followup): blocked by axe-global transitive deps in lib/commons/aria/roles.ts.
...
describe.todo('aria.roles', () => {
  it.todo(
    'migrated from test/commons/aria/roles.js — restore body once Phase 1 gap closed'
  );
});
