// FIXME(phase-01-followup): blocked by axe-global transitive deps in lib/commons/aria/get-roles-by-type.ts.
...
describe.todo('aria.getRolesByType', () => {
  it.todo(
    'migrated from test/commons/aria/get-roles-by-type.js — restore body once Phase 1 gap closed'
  );
});
