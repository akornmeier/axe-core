// FIXME(phase-01-followup): blocked by axe-global transitive deps in lib/commons/aria/is-combobox-popup.ts.
...
describe.todo('aria.isComboboxPopup', () => {
  it.todo(
    'migrated from test/commons/aria/is-combobox-popup.js — restore body once Phase 1 gap closed'
  );
});
