// FIXME(phase-01-followup): blocked by axe-global transitive deps in lib/commons/aria/required-context.ts.
...
describe.todo('aria.requiredContext', () => {
  it.todo(
    'migrated from test/commons/aria/required-context.js — restore body once Phase 1 gap closed'
  );
});
