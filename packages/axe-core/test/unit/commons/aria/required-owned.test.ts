// FIXME(phase-01-followup): blocked by axe-global transitive deps in lib/commons/aria/required-owned.ts.
...
describe.todo('aria.requiredOwned', () => {
  it.todo(
    'migrated from test/commons/aria/required-owned.js — restore body once Phase 1 gap closed'
  );
});
