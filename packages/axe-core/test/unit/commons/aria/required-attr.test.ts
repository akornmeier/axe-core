// FIXME(phase-01-followup): blocked by axe-global transitive deps in lib/commons/aria/required-attr.ts.
...
describe.todo('aria.requiredAttr', () => {
  it.todo(
    'migrated from test/commons/aria/required-attr.js — restore body once Phase 1 gap closed'
  );
});
