// FIXME(phase-01-followup): blocked by axe-global transitive deps in lib/commons/dom/focus-disabled.ts.
...
describe.todo('dom.focusDisabled', () => {
  it.todo(
    'migrated from test/commons/dom/focus-disabled.js — restore body once Phase 1 gap closed'
  );
});
