 ...
 * @deprecated
 */
export default function onlyDlitemsEvaluate(
  this: any,
  node: HTMLElement,
  ...
  const base = {
    badNodes: [] as HTMLElement[],
    hasNonEmptyTextNode: false
  };

  const content = virtualNode.children.reduce((vNodes: any[], child: any) => {
  ...
  const result = content.reduce((out: any, childNode: any) => {
