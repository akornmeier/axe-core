...
export default function colorContrastEvaluate(
  this: any,
  node: HTMLElement,
  options: any,
  virtualNode: any
  ...
  let contrastContributor: string | null = null;
...
function findPseudoElement(
  vNode: any,
  { pseudoSizeThreshold = 0.25, ignorePseudo = false }: any
): any {
  if (ignorePseudo) {
    return;
  }
...
function textIsEmojis(visibleText: string): boolean {
...
function parseUnit(str: string): { value: number; unit: string } {
