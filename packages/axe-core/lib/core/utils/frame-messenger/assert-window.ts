...
export function assertIsParentWindow(win: Window): void {
...
export function assertIsFrameWindow(win: Window): void {
  assetNotGlobalWindow(win);
  assert(
    win.parent === window,
...
export function assetNotGlobalWindow(win: Window): void {
