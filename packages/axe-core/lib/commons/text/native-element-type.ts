export interface NativeElementMatchProperties {
...
export interface NativeElementMatch {
  nodeName: string;
  properties?: NativeElementMatchProperties;
}

export interface NativeElementEntry {
  matches: string | string[] | NativeElementMatch | NativeElementMatch[];
  namingMethods: string | string[];
}

const nativeElementType: NativeElementEntry[] = [
  {
