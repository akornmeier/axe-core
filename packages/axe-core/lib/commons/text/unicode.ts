 ...
 * @returns {RegExp}
 */
export function getUnicodeNonBmpRegExp(): RegExp {
  /**
 ...
 * @returns {RegExp}
 */
export function getPunctuationRegExp(): RegExp {
  /**
 ...
 * @returns {RegExp}
 */
export function getSupplementaryPrivateUseRegExp(): RegExp {
 ...
 * @returns {RegExp}
 */
export function getCategoryFormatRegExp(): RegExp {
  return /[\xAD\u0600-\u0605\u061C\u06DD\u070F\u08E2\u180E\u200B-\u200F\u202A-\u202E\u2060-\u2064\u2066-\u206F\uFEFF\uFFF9-\uFFFB]|\uD804[\uDCBD\uDCCD]|\uD80D[\uDC30-\uDC38]|\uD82F[\uDCA0-\uDCA3]|\uD834[\uDD73-\uDD7A]|\uDB40[\uDC01\uDC20-\uDC7F]/g;
}
