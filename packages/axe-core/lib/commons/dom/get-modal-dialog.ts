 ...
 */
const getModalDialog: () => any | null = memoize(
  function getModalDialogMemoized(): any | null {
    ...
    const modalDialog = dialogs.find((dialog: any) => {
 ...
 * @return {Object}
 */
function getNodeFromGrid(dialog: any): GridNodeResult | undefined {
  createGrid();
  // TODO: es-module-_tree
  const grid = (axe as any)._tree[0]._grid;
