 ...
 */
export default function isVisibleToScreenReaders(vNode: any): boolean {
 ...
 */
const isVisibleToScreenReadersVirtual: (
  vNode: any,
  isAncestor?: boolean
) => boolean = memoize(function isVisibleToScreenReadersMemoized(
  vNode: any,
  isAncestor?: boolean
): boolean {
  if (
