 ...
 */
function getTargetSize(vNode: any, minSize: number): DOMRect {
...
function getLargestRect(rects: DOMRect[], minSize: number): DOMRect {
  return rects.reduce((rectA: DOMRect, rectB: DOMRect) => {
