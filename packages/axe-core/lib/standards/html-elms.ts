...
interface MatchesObject {
  attributes?: Record<string, string | (string | null)[] | null>;
...
type Matches =
  | string
  | MatchesObject
  | (MatchesObject | { attributes: Record<string, string> })[];

interface HtmlElmVariant {
  matches?: Matches;
  contentTypes?: ContentType[];
  allowedRoles?: boolean | string[];
  noAriaAttrs?: boolean;
  shadowRoot?: boolean;
  implicitAttrs?: Record<string, string>;
  namingMethods?: string[];
}

export interface HtmlElmDefinition {
  contentTypes?: ContentType[];
  allowedRoles?: boolean | string[];
  noAriaAttrs?: boolean;
  shadowRoot?: boolean;
  ...
  namingMethods?: string[];
  chromiumRole?: string;
  variant?: Record<string, HtmlElmVariant>;
}

const htmlElms: Record<string, HtmlElmDefinition> = {
  a: {
